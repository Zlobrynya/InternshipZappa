                ...
                reg_email.onFocusChangeListener = object : View.OnFocusChangeListener {
                    override fun onFocusChange(v: View?, hasFocus: Boolean) {
                        ...
                        if (!hasFocus && !validateEmail) {
                            reg_email_input_layout.error = getString(com.zappa.narogah.R.string.error_email)
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                if (reg_password.length()<8){
                    ...
                    reg_confirm_password_input_layout.error =
                            getString(com.zappa.narogah.R.string.error_confirm_password)
            ...
            ?.subscribe(object : Observer<Response<respDTO>> {
                ...
                override fun onNext(t: Response<respDTO>) {
                    if (t.isSuccessful) {
                        val icon = resources.getDrawable(com.zappa.narogah.R.drawable.error)
                        icon?.setBounds(0, 0, icon.intrinsicWidth, icon.intrinsicHeight)
                        reg_email_input_layout.error = getString(com.zappa.narogah.R.string.exist_email)
                        reg_email.setCompoundDrawables(null, null, icon, null)
