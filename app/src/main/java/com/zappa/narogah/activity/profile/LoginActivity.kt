package com.zappa.narogah.activity.profile
...
import com.zappa.narogah.tools.retrofit.DTOs.accountDTOs.authDTO
import com.zappa.narogah.tools.retrofit.DTOs.accountDTOs.authRespDTO
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.zappa.narogah.R.layout.activity_login)

        supportActionBar!!.title = "Вход"
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        supportActionBar!!.setBackgroundDrawable(resources.getDrawable(com.zappa.narogah.R.drawable.actionbar))
        ...
        val icon = resources.getDrawable(com.zappa.narogah.R.drawable.error)
        ...
        log_email.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                ...
                if (validateEmail && validatePassword){
                    btnLogin.background = getDrawable(com.zappa.narogah.R.drawable.btn_can_click)
                    btnLogin.isEnabled = true
                } else {
                    btnLogin.background = getDrawable(com.zappa.narogah.R.drawable.btn_not_click)
                ...
                log_email.onFocusChangeListener = object : View.OnFocusChangeListener {
                    override fun onFocusChange(v: View?, hasFocus: Boolean) {
                        ...
                        if (!hasFocus && !validateEmail) {
                            log_email_input_layout.error = getString(com.zappa.narogah.R.string.error_email)
                    ...
                    override fun onFocusChange(v: View?, hasFocus: Boolean) {
                        ...
                        if (!hasFocus && !validatePassword) {
                            log_password_input_layout.error =
                                getString(com.zappa.narogah.R.string.error_password)
                    ...
                    override fun onNext(t: Response<authRespDTO>) {
                        if (t.isSuccessful) {
                            val sharedPreferencesStat = applicationContext.getSharedPreferences(
                                applicationContext.getString(com.zappa.narogah.R.string.user_info),
                                Context.MODE_PRIVATE
                            )
                            val savedEmail =
                                applicationContext.getString(com.zappa.narogah.R.string.user_email)
                            val access_token =
                                applicationContext.getString(com.zappa.narogah.R.string.access_token)
                            ...
                            log_email_input_layout.error =
                                getString(com.zappa.narogah.R.string.wrong_password_email)
                            log_email.setCompoundDrawables(null, null, icon, null)
                            log_password_input_layout.error =
                                getString(com.zappa.narogah.R.string.wrong_password_email)
                            log_password.setCompoundDrawables(null, null, icon, null)
    ...
    private fun showNoInternetConnectionAlert(authDTO: authDTO, icon: Drawable) {
        if (!alertIsShown) {
            ...
            val builder: AlertDialog.Builder =
                AlertDialog.Builder(this, com.zappa.narogah.R.style.AlertDialogCustom)
            ...
            alert.getButton(AlertDialog.BUTTON_POSITIVE)
                .setTextColor(resources.getColor(com.zappa.narogah.R.color.color_accent))
