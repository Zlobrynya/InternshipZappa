...
import com.zappa.narogah.activity.profile.CodeFEmailActivity
import com.zappa.narogah.tools.retrofit.DTOs.accountDTOs.changeUserDataDTO
import com.zappa.narogah.tools.retrofit.DTOs.accountDTOs.changeUserDataRespDTO
import com.zappa.narogah.tools.retrofit.DTOs.accountDTOs.verifyEmailDTO
import com.zappa.narogah.tools.retrofit.DTOs.accountDTOs.verifyRespDTO
                    ...
                    override fun onFocusChange(v: View?, hasFocus: Boolean) {
                        ...
                        if (!hasFocus && !validateName) {
                            edit_profile_username_input_layout.error =
                                getString(com.zappa.narogah.R.string.error_name)
                    ...
                    override fun onFocusChange(v: View?, hasFocus: Boolean) {
                        ...
                        if (!hasFocus && !validateEmail) {
                            edit_profile_email_input_layout.error =
                                getString(com.zappa.narogah.R.string.error_email)
                    ...
                    override fun onFocusChange(v: View?, hasFocus: Boolean) {
                        ...
                        if (!hasFocus && !validatePhone) {
                            edit_profile_phone_number_input_layout.error =
                                getString(com.zappa.narogah.R.string.error_phone)
            ...
            ?.subscribe(object : Observer<Response<respDTO>> {
                ...
                override fun onNext(t: Response<respDTO>) {
                    ...
                    if (t.isSuccessful) {
                        ...
                        val icon = resources.getDrawable(com.zappa.narogah.R.drawable.error)
                        icon?.setBounds(0, 0, icon.intrinsicWidth, icon.intrinsicHeight)
                        edit_profile_email_input_layout.error = getString(com.zappa.narogah.R.string.exist_email)
                        edit_profile_email.setCompoundDrawables(null, null, icon, null)
                        canClickSaveButton = true
