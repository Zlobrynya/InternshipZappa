...
import com.zlobrynya.narogah.tools.retrofit.DTOs.accountDTOs.authDTO
import com.zlobrynya.narogah.tools.retrofit.DTOs.accountDTOs.authRespDTO
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.zlobrynya.narogah.R.layout.activity_login)

        supportActionBar!!.title = "Вход"
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        supportActionBar!!.setBackgroundDrawable(resources.getDrawable(com.zlobrynya.narogah.R.drawable.actionbar))
        ...
        log_email.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                ...
                if (validateEmail && validatePassword){
                    btnLogin.background = getDrawable(com.zlobrynya.narogah.R.drawable.btn_can_click)
                    btnLogin.isEnabled = true
                } else {
                    btnLogin.background = getDrawable(com.zlobrynya.narogah.R.drawable.btn_not_click)
                ...
                log_email.onFocusChangeListener = object : View.OnFocusChangeListener {
                    override fun onFocusChange(v: View?, hasFocus: Boolean) {
                        ...
                        if (!hasFocus && !validateEmail) {
                            log_email_input_layout.error = getString(com.zlobrynya.narogah.R.string.error_email)
                    ...
                    override fun onNext(t: Response<authRespDTO>) {
                        if (t.isSuccessful) {
                            val sharedPreferencesStat = applicationContext.getSharedPreferences(
                                applicationContext.getString(com.zlobrynya.narogah.R.string.user_info),
                                Context.MODE_PRIVATE
                            )
                            val savedEmail =
                                applicationContext.getString(com.zlobrynya.narogah.R.string.user_email)
                            val access_token =
                                applicationContext.getString(com.zlobrynya.narogah.R.string.access_token)
                            ...
                            log_email_input_layout.error =
                                getString(com.zlobrynya.narogah.R.string.wrong_password_email)
                            log_email.setCompoundDrawables(null, null, icon, null)
                            log_password_input_layout.error =
                                getString(com.zlobrynya.narogah.R.string.wrong_password_email)
                            log_password.setCompoundDrawables(null, null, icon, null)
    ...
    private fun showNoInternetConnectionAlert(authDTO: authDTO, icon: Drawable) {
        if (!alertIsShown) {
            ...
            val builder: AlertDialog.Builder =
                AlertDialog.Builder(this, com.zlobrynya.narogah.R.style.AlertDialogCustom)
            ...
            alert.getButton(AlertDialog.BUTTON_POSITIVE)
                .setTextColor(resources.getColor(com.zlobrynya.narogah.R.color.color_accent))
