...
import com.zlobrynya.narogah.tools.retrofit.DTOs.accountDTOs.passwordRecoveryDTO
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (change_password_code_email.text.toString().length < 5) {
                    change_password_code_email_layout.error =
                        getString(com.zlobrynya.narogah.R.string.code_null)
            ...
            ?.subscribe(object : Observer<Response<respDTO>> {
                ...
                override fun onNext(t: Response<respDTO>) {
                    if (t.isSuccessful) {
                        ...
                        val icon = resources.getDrawable(com.zlobrynya.narogah.R.drawable.error)
                        icon?.setBounds(0, 0, icon.intrinsicWidth, icon.intrinsicHeight)
                        change_password_code_email_layout.error = getString(com.zlobrynya.narogah.R.string.wrong_code)
                        change_password_code_email.setCompoundDrawables(null, null, icon, null)
