...
class PasswordRecovery : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val icon: Drawable = resources.getDrawable(com.zlobrynya.narogah.R.drawable.error)
        ...
        register_email.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (!validateEmail) {
                    register_email_input_layout.error = getString(com.zlobrynya.narogah.R.string.error_email)
                ...
                override fun onNext(t: Response<respDTO>) {
                    if (t.isSuccessful) {
                        ...
                        register_email_input_layout.error =
                            getString(com.zlobrynya.narogah.R.string.user_not_exist)
                        register_email.setCompoundDrawables(null, null, icon, null)
