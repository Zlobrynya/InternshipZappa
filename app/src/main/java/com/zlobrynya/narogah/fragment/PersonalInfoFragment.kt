...
import com.zlobrynya.narogah.activity.booking.BookingEnd
...
class PersonalInfoFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        if (seatPosition == "" && seatCount == "4") {
            val textTable = getString(com.zlobrynya.narogah.R.string.table4, bookTableId, seatCount, seatType)
            view.fm_selected_table.setText(textTable)
        } else if (seatPosition == "" && seatCount != "4") {
            val textTable = getString(com.zlobrynya.narogah.R.string.table68, bookTableId, seatCount, seatType)
            view.fm_selected_table.setText(textTable)
        } else if (seatPosition != "" && seatCount == "4") {
            val textTable = getString(
                com.zlobrynya.narogah.R.string.table43,
                bookTableId,
                seatCount,
                seatPosition,
                seatType
            ...
            val textTable =
                getString(
                    com.zlobrynya.narogah.R.string.table683,
                    bookTableId,
                    seatCount,
                    seatPosition,
                    seatType
        ...
        var text = getString(com.zlobrynya.narogah.R.string.period, woSecI, woSecO)
